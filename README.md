...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/mhagerty-heap/cstoreNew)

> **Note:** The database (including all products and the 200 demo user accounts) is bundled with the repo, so your Vercel deployment is ready to use immediately after deploy.
